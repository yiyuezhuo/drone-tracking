...
# Adaption from older work: https://raw.githubusercontent.com/yiyuezhuo/Pointer-Detection/master/pointer_utils.py
...
modelConfiguration = "../yolo-cfg/yolov3-tiny-bin_obj.cfg"
modelWeights = "backup/yolov3-tiny-bin_obj_final.weights"
